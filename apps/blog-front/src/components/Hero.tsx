...
const Hero = () => {
  return <div className="bg-gradient-to-br from-sky-500 to-indigo-500 text-white pt-16">
    <div className="container mx-auto flex flex-col md:flex-row items-center flex-wrap px-3">
      ...
      <div className="w-full md:w-3/5 py-7 flex justify-center">
        <Image
          src="/hero.png"
          alt="hero"
          width={500}
          height={500}
          className="w-full md:w-full h-auto object-contain max-w-[500px]"
          sizes="(max-width: 768px) 100vw, 60vw" // 优化加载
        />
      </div>
    </div>
